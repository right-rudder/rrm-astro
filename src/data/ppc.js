const ppc = {
  data: {
    ...
    whatsPpc: {
      ...
      description: `Pay per click ads are just like the name implies. For every click on Google on your ad, you need to pay a fee to Google. It's a great way to get your flight school in front of targeted prospective students that are not in your immediate network.`,
      paragraphs: [
