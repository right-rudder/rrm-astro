const ppcFacebook = {
  data: {
    //SEO Header Stuff
    pageTitle: "Facebook Ads - Pay Per Click | Right Rudder Marketing",
    pageDescription:
      "Lear how to use Facebook Ads to market your flight school. We create and manage pay-per-click advertising campaigns that drive traffic, leads, and sales to your business. Facebook ads are a great way to get in front of prospective students that are not in your immediate network.",
    pageKeywords:
      "Facebook Ads, Pay Per Click, PPC, Google Ads, Flight School Marketing, Flight Training Marketing, Pilot Training Marketing, Aviation Marketing, Flight School Advertising, Pilot Training Advertising, Aviation Advertising, Flight School Leads, Pilot Training Leads, Aviation Leads, Flight School Sales, Pilot Training Sales, Aviation Sales, Flight School Traffic, Pilot Training Traffic, Aviation Traffic",
    ...
    //main content
    whatsPpc: {
      imagePath: "/src/assets/william-topa-7_4bU5tHRLQ-unsplash.jpg",
      imageAlt: "Right Rudder Marketing team on the runway",
      upperHeading: "What is PPC?",
      heading: "Pay-Per-Click Advertising",
      description: `Pay per click ads are just like the name implies. For every click on Facebook and Instagram on your ad, you need to pay a fee to Meta. It's a great way to get your flight school in front of targeted prospective students that are not in your immediate network. Whenever you post something on your social media profile, your post will only circulate and be syndicated to mostly people that have liked and followed your page. If you're looking for a way to expand your reach, Facebook ads acts like the classified ads in a newspaper. You can get your business in front of people that have never heard of your flight school.`,
      paragraphs: [
      ...
      list: {
        ...
        items: [
          ...
          {
            icon: "M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z",
            title: "Facebook Ads not converting.",
            descriptions: [
      ...
      finalSection: {
        heading: "How much is a student pilot worth?",
        descriptions: [
    ...
    rightWay: {
      ...
      heading: "What's the right way to go about running Facebook Ads?",
      paragraphs: [
    ...
    features: {
      ...
      description: `Use lead generation retargeting ads and capture leads that already know about you, but haven't converted into a student pilot yet. Let's get those future pilots in your school!`,
      features: [
        {
          title: "Secure Your Facebook Business Account",
          description:
        ...
        {
          title: "Integrate and Automate CRM Processes",
          description:
