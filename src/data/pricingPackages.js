export const pricingPackages = {
  ...
  "six-pack": {
    ...
    includedServices: [
      ...
      "Reporting & Data Tracking",
      "Local Business Listings (once yearly)",
      "Content Creation (2 blogs per month)",
  ...
  "glass-cockpit": {
    ...
    includedServices: [
      ...
      "Local Business Listings (twice yearly)",
  ...
  "fly-by-wire": {
    ...
    includedServices: [
      ...
      "Content Creation (4 blogs per month)",
      "Press Releases (up to 8 per year)",
      "Video Production (2 sessions annually)",
