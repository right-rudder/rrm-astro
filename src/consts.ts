...
export const SITE_TITLE =
  "Digital Marketing for Flight Schools | Right Rudder Marketing";
...
export const SITE_DESCRIPTION =
  "Right Rudder Marketing is the leading digital marketing agency specializing in flight school growth. We help aviation businesses scale with proven SEO, PPC, website design, and lead generation strategies. Partner with us to double, triple, or 10X your student enrollment. Trusted by 100+ flight schools across America.";
...
export const LOCATIONS = [
  {
    title: "Main Office",
    address: "4411 Woodson Road Suite 101A",
    city: "St. Louis",
    state: "MO",
    zip: "63134",
