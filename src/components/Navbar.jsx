        ...
        <div className="px-5 max-w-7xl mx-auto top-0">
          ...
          >
            <div className="flex w-full items-center justify-between">
              <a
                href="/"
                className="relative hover:brightness-110 duration-200 ease-in-out w-1/4 lg:w-2/6"
              >
                <img
                      ...
                      {item.submenu && item.submenu.length > 0 && (
                        ...
                        >
                          {item.submenu.map((subitem, subIndex) => (
                            <li
                              key={subIndex}
                              className={`${isActive(subitem, pathname) ? "bg-accent text-primary-dark" : ""} relative hover:bg-accent`}
