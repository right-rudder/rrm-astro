...
const DownloadKeywords = ({ webhook, apiKey }) => {
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-20">
          <div className="bg-white p-12 max-w-md m-4 text-black relative rounded-md">
            ...
            {formSubmitted && (
              <>
                <VscSymbolKeyword className="text-primary-600 text-9xl text-center mx-auto" />
                <h2 className="text-4xl font-bold mt-6 mb-4">
                  Thank you {userName}, for downloading our Keywords Guide!
                </h2>
