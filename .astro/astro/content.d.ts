...
"effective-homepage-layout-for-a-flight-school-targeting-aspiring-pilots.md": {
	id: "effective-homepage-layout-for-a-flight-school-targeting-aspiring-pilots.md";
  slug: "effective-homepage-layout-for-a-flight-school-targeting-aspiring-pilots";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
...
"faa-reverts-notice-from-air-missions-to-airmen-notam.md": {
	id: "faa-reverts-notice-from-air-missions-to-airmen-notam.md";
  slug: "faa-reverts-notice-from-air-missions-to-airmen-notam";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
...
"how-to-build-a-unique-value-proposition-that-attracts-more-pilots.md": {
	id: "how-to-build-a-unique-value-proposition-that-attracts-more-pilots.md";
  slug: "how-to-build-a-unique-value-proposition-that-attracts-more-pilots";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
...
"master-your-checkride-with-mary-schu-dpe.md": {
	id: "master-your-checkride-with-mary-schu-dpe.md";
  slug: "master-your-checkride-with-mary-schu-dpe";
  body: string;
  collection: "podcasts";
  data: InferEntrySchema<"podcasts">
} & { render(): Render[".md"] };
...
"tammy-barlette-crosscheck-mental-performance-training.md": {
	id: "tammy-barlette-crosscheck-mental-performance-training.md";
  slug: "tammy-barlette-crosscheck-mental-performance-training";
  body: string;
  collection: "podcasts";
  data: InferEntrySchema<"podcasts">
} & { render(): Render[".md"] };
